...
//Paramètres de connexion à la base de données MySQLs
...
$sql = "SELECT * FROM TOURNOIS AS t
        LEFT JOIN PARTICIPATION AS p ON p.numero_tournois = t.id_tournois
        AND t.id_tournois NOT IN (SELECT numero_tournois FROM PARTICIPATION WHERE email = '$email_connecte');";
